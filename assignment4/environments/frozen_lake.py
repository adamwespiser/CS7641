...
MAPS = {
    ...
    "20x20b": [
        ...
        "FFFFFFFHHHFFFFFFHHFF",
        "FFHFFFFFFFFHHFFFFFFF",
        "FFFFFFFFFFFFFFFFHHFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFHFFFFFFFFFFFFFF",
        "FFFFFFFFHFFFFFFFHHFF",
        "FFFFFHFFFFHHFFFFFFFF",
        "FFFFFHFFFFFFFFFFHHFF",
        "FFFFFHFFFFFFFFFFHHFF",
        "FFFFFFFFFFFFHFFHHHFF",
        "FHHHFHFFFFFFFFFFHHFF",
        "FFFFFHFFFFHFFFFFHHFF",
        "FFFFFFFFFFFFFFFFFHFF",
        "FFFFFHFFFFFFHFFFFFFF",
        "FFFFFHFFFFFFFFFFFFFF",
        "FFFFFFFFFFFHFFFFFFFF",
        "FHHFFFHFFFFHFFFFFHFF",
        "FHHFHFHFFFFFFFFFFFFF",
        "FFFHFFFFFHFFFFHHFFFG"
    ]
}
...
class FLakeEnv(discrete.DiscreteEnv):
    """
    Winter is here. You and your friends were tossing around a frisbee at the park
    when you made a wild throw that left the frisbee out in the middle of the lake.
    The water is mostly frozen, but there are a few holes where the ice has melted.
    ...
    def __init__(self,
        ...
        super(FLakeEnv, self).__init__(nS, nA, P, isd)
    ...
    def new_instance(self):
        return FLakeEnv(desc=self.desc,
